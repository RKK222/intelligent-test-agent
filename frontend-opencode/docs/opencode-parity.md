...
- Prompt composer 附件/@ 文件选择、图片选择/粘贴/拖拽、Agent/Model/Variant 运行态选择、shell mode 和 slash command runtime 分流已走平台代理；完整 opencode 参数表单化补全和更完整编辑器级键盘导航仍需继续补齐。
