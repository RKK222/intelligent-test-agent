...
Workspace 和文件管理业务包，负责工作区注册、查询、文件路径归一化、越权路径拒绝、UTF-8 文件读写和文件状态查询。
...
- `docs/api/backend-api.md`，如果文件或 workspace API 行为变化。
- `docs/backend/backend-testing-standards.md`，如果测试策略变化。
