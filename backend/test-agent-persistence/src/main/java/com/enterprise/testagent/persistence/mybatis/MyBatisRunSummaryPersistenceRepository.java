...
public class MyBatisRunSummaryPersistenceRepository implements RunSummaryPersistencePort {
    ...
    @Override
    public Optional<RunDetailsLocator> findDetailsLocator(com.enterprise.testagent.domain.run.RunId runId) {
        return Optional.ofNullable(mapper.findDetailsLocator(runId.value()))
                .map(row -> new RunDetailsLocator(
                        new com.enterprise.testagent.domain.run.RunId(row.runId()),
    ...
    @Override
    public boolean recordDiffAction(com.enterprise.testagent.domain.run.RunId runId, RunDiffAction action) {
    ...
    @Override
    public List<RunConversationSummary> findSummariesByRunId(com.enterprise.testagent.domain.run.RunId runId) {
