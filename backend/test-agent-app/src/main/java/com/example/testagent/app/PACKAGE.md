...
- `terminal.TerminalApplicationService`、`web.TerminalController`、`web.TerminalWebSocketHandler`：Phase 11 P2 受控 PTY 入口，负责一次性 ticket、workspace/cwd 校验、Origin 校验和 JSON envelope WebSocket 通道；不访问 generated SDK，也不允许前端覆盖 shell。
