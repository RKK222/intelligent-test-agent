...
public class TerminalTicketRateLimiter {
    ...
    public TerminalTicketRateLimiter(TestAgentRuntimeProperties properties) {
        this(Clock.systemUTC(), properties.getTerminal().getTicketCapacity(), properties.getTerminal().getTicketWindow());
    }
