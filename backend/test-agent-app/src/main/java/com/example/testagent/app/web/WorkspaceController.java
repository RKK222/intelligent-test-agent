...
import com.example.testagent.app.workspace.FileContentResponse;
import com.example.testagent.app.workspace.FileStatusResponse;
import com.example.testagent.app.workspace.FileTreeEntryResponse;
...
public class WorkspaceController {
    ...
    @GetMapping("/api/workspaces/{workspaceId}/files/content")
    ...
    @PutMapping("/api/workspaces/{workspaceId}/files/content")
    ...
    @GetMapping("/api/workspaces/{workspaceId}/files/status")
