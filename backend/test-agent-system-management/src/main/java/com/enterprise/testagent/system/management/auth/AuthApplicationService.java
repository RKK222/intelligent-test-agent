...
import com.enterprise.testagent.domain.user.UserLoginLog;
...
public class AuthApplicationService {
     ...
     * @throws com.enterprise.testagent.common.error.PlatformException 用户名或密码错误时
     */
    public AuthPrincipal login(String username, String rawPassword, String ipAddress, String userAgent) {
        ...
        if (!userDomainService.verifyPassword(user, rawPassword)) {
            ...
            throw new com.enterprise.testagent.common.error.PlatformException(
                    com.enterprise.testagent.common.error.ErrorCode.UNAUTHENTICATED, "用户名或密码错误");
        }
