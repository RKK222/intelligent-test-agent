...
class OpencodeCreateSessionCommandTest {
    ...
    private static OpencodeCreateSessionCommand command(String title) {
        return new OpencodeCreateSessionCommand(node(), "/tmp/demo", null, title, "trace_1234567890abcdef");
    }
