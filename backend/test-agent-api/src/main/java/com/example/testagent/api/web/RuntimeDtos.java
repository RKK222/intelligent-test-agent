...
final class RuntimeDtos {
    ...
    record RunDiffFileResponse(
         ...
         */
        static RunDiffFileResponse from(com.example.testagent.opencode.runtime.run.RunDiffFileResponse file) {
    ...
    record RunDiffResponse(
         ...
         */
        static RunDiffResponse from(com.example.testagent.opencode.runtime.run.RunDiffResponse diff) {
    ...
    record RunDiffActionResponse(
         ...
         */
        static RunDiffActionResponse from(com.example.testagent.opencode.runtime.run.RunDiffActionResponse action) {
