...
class AgentConfigBackendRoutingService {
    ...
    AgentConfigBackendRoutingService(AgentConfigApplicationService service) {
        this(
            ...
            @Override public void recordBackendHeartbeat(com.enterprise.testagent.domain.opencodeprocess.LinuxServerId linuxServerId, java.time.Instant heartbeatAt) {}
            ...
            @Override public void recordOpencodeHeartbeat(com.enterprise.testagent.domain.opencodeprocess.OpencodeProcessId processId, java.time.Instant heartbeatAt) {}
            @Override public List<BackendRuntimeSnapshot> liveBackendSnapshots() { return List.of(); }
            @Override public List<com.enterprise.testagent.domain.opencodeprocess.ManagerRuntimeSnapshot> liveManagerSnapshots() { return List.of(); }
