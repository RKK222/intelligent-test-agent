...
import com.enterprise.testagent.configuration.management.ConfigurationManagementResponses.CodeRepositoryResponse;
import com.enterprise.testagent.configuration.management.ConfigurationManagementResponses.RepositoryDeploymentOptionResponse;
import com.enterprise.testagent.configuration.management.ConfigurationManagementResponses.RepositoryDeploymentOptionsResponse;
import com.enterprise.testagent.configuration.management.ConfigurationManagementResponses.RepositoryTreeNodeResponse;
import com.enterprise.testagent.configuration.management.ConfigurationManagementResponses.RepositoryTreeResponse;
import com.enterprise.testagent.configuration.management.ConfigurationManagementResponses.RepositoryTypeOptionResponse;
import com.enterprise.testagent.configuration.management.ConfigurationManagementResponses.SshKeyResponse;
...
import com.enterprise.testagent.workspace.ManagedWorkspaceResponses.ApplicationWorkspaceCreateResponse;
import com.enterprise.testagent.workspace.ManagedWorkspaceResponses.ApplicationWorkspaceVersionResponse;
import com.enterprise.testagent.workspace.ManagedWorkspaceResponses.WorkspaceCreateOperationResponse;
import com.enterprise.testagent.workspace.ManagedWorkspaceResponses.WorkspaceCreateOperationStepResponse;
...
class ConfigurationManagementControllerTest {
    ...
    void createWorkspaceUsesCurrentUserReadyOpencodeServer() {
        ...
        when(workspaceService.createWorkspaceAccepted(
                ...
                eq("10.8.0.12"),
                eq(TRACE_ID)))
                .thenReturn(new com.enterprise.testagent.workspace.ManagedWorkspaceResponses.CreateWorkspaceAcceptedResponse(
                        "wco_12345678",
                        "ACCEPTED",
    ...
    private WebTestClient client(
        ...
        return WebTestClient.bindToController(new ConfigurationManagementController(
                        ...
                        workspaceService,
                        assignmentService,
                        new com.enterprise.testagent.common.git.RsaKeyService()))
