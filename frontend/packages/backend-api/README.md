...
`backend-api.test.ts` 覆盖 7 个引用资产端点的 app/repository/path 编码、初始化/切换 body、无 body 同步/核验和响应透传，以及组合视图 list/read 的 locator、稳定身份、只读来源和局部 warning 映射。
