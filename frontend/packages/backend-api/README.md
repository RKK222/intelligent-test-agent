...
- 暴露 Phase 11 opencode Web App 运行态方法：Agent/Model/Provider/Command/Reference 目录、Session children/todo/diff/abort/fork/compact/revert/command/shell、permission/question、fs/vcs/lsp/mcp status/resources/tools 和 terminal ticket。
