...
<template>
  <div :class="['oc-assistant-frame', continuation ? 'is-continuation' : '']">
    <div v-if="!continuation" class="oc-assistant-frame__avatar" aria-hidden="true">
      <Bot class="oc-assistant-frame__avatar-icon" />
    </div>
    <div class="oc-assistant-frame__content">
      <div v-if="!continuation" class="oc-assistant-frame__meta">
        <span>测试智能体</span>
