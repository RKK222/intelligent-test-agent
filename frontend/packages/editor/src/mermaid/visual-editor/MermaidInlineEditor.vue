...
.ta-mermaid-inline-editor label textarea { box-sizing: border-box; width: 100%; min-height: 60px; border: 1px solid var(--ta-border, #dbe2ea); border-radius: 5px; padding: 6px 8px; background: var(--ta-surface, #fff); color: var(--ta-ink, #172033); font: inherit; font-size: 12px; resize: vertical; }
