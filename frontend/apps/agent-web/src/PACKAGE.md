...
- 首次登录引导在 `FirstLoginGuide.vue` 中复用真实的应用下拉、workspace/version 切换、小地球、对话按钮、宠物、设置和手册锚点，说明普通用户的应用、workspace、首条对话、需求子条目和设置权限入口；引导文案与 `apps/user-manual/docs/guide/` 相关章节同步维护。
