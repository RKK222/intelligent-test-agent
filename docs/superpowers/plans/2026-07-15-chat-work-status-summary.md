...
- [x] **Step 3: 最小化实现事件行条件渲染并确认 GREEN**
...
- [x] **Step 4: 为成功完成态摘要、actions 插槽和展开顺序写失败测试**
...
- [x] **Step 7: 运行 agent-chat 回归与类型检查并提交**
