...
- [ ] **Step 3: Add the smallest robot position controller**
...
- [ ] **Step 3: Implement one shared placement calculation**
...
- [ ] **Step 2: Run targeted and workspace checks**
...
- [ ] **Step 4: Add the session entry and make one final commit**
