 ...
 */
@JsonPropertyOrder({
  ForbiddenError.JSON_PROPERTY_TAG,
...
public class ForbiddenError {
   ...
   */
  public enum TagEnum {
    FORBIDDEN_ERROR(String.valueOf("ForbiddenError"));
  ...
  public ForbiddenError tag(@jakarta.annotation.Nonnull TagEnum tag) {
  ...
  public ForbiddenError message(@jakarta.annotation.Nonnull String message) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tag, forbiddenError.tag) &&
